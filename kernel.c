...
// Nouvelle fonction pour convertir un nombre en hexadécimal
...
// Fonction pour afficher la pile kernel
...
void kernel_main(void) 
{
    ...
    terminal_writestring("Initial kernel stack trace:\n");
    print_kernel_stack();
}